    ...
    public CalendarCustomView(final Context context, @Nullable AttributeSet attrs) {
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                View eventView = LayoutInflater.from(parent.getContext()).inflate(R.layout.addneweventlayout,null);
...
// Toast.makeText(context, String.valueOf(arrayList.size()), Toast.LENGTH_SHORT).show();
    ...
    private void SetupCalendar(){
        ...
        Calendar c=Calendar.getInstance();
        MyGridAdapter gridAdapter=new MyGridAdapter(context,dateList,calendar,eventsList);
     int pos= dateList.indexOf(c);
    }

...
public class SliderAdapter extends PagerAdapter {
    ...
    public String[] slideDescriptions ={
            "Record your meals and insulin injections.",
            "A health diary for recording symptoms and blood readings.",
            "Track your records and add notifications for doctor's appointment."
    };
